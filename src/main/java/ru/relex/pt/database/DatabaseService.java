...
public class DatabaseService {
	...
	public PwEntrance createEntrance(String cardId, String direction) throws NotAuthrizedException 
	{
	...
	public List<PwEntrance> getEntrances(long since)
	{
		List<PwEntrance> result = new LinkedList<PwEntrance>();
		for (PwEntrance e: database.getEntrances())
			if (e.getPassTime().getTime() > since && e.getStatus().equals("active"))
				result.add(e);
	...
	public void updateEntrance(long id, String status, int absentTimeMin, String absentType) 
			throws NotFoundEntranceException, UnknownStatusException,	IllegalOperationSequenceException, InvalidAbsentTypeException
	{
